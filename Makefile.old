# This Makefile is for the CBitcoin extension to perl.
#
...
#     TYPEMAPS => []
#     VERSION => q[0.01]
#     VERSION_FROM => q[lib/CBitcoin.pm]
#     clean => { FILES=>q[libperl-cbitcoin-*] }
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/joeldejesus/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKEMAKER   = /home/joeldejesus/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 7.04
MM_REVISION = 70400
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/CBitcoin.pm \
	lib/CBitcoin/CBHD.pm \
	lib/CBitcoin/Script.pm \
	lib/CBitcoin/Transaction.pm \
	lib/CBitcoin/TransactionInput.pm \
	lib/CBitcoin/TransactionOutput.pm
...
PM_TO_BLIB = lib/CBitcoin.pm \
	blib/lib/CBitcoin.pm \
	lib/CBitcoin/CBHD.pm \
	blib/lib/CBitcoin/CBHD.pm \
	lib/CBitcoin/Script.pm \
	blib/lib/CBitcoin/Script.pm \
	lib/CBitcoin/Transaction.pm \
	blib/lib/CBitcoin/Transaction.pm \
	lib/CBitcoin/TransactionInput.pm \
	blib/lib/CBitcoin/TransactionInput.pm \
	lib/CBitcoin/TransactionOutput.pm \
	blib/lib/CBitcoin/TransactionOutput.pm
...
XSPROTOARG = 
XSUBPPDEPS = /usr/share/perl/5.20/ExtUtils/typemap /usr/share/perl/5.20/ExtUtils$(DFSEP)xsubpp
...
# CBitcoin might depend on some other libraries:
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  lib/CBitcoin.pm $(INST_MAN3DIR)/CBitcoin.$(MAN3EXT) \
	  lib/CBitcoin/CBHD.pm $(INST_MAN3DIR)/CBitcoin::CBHD.$(MAN3EXT) \
	  lib/CBitcoin/Script.pm $(INST_MAN3DIR)/CBitcoin::Script.$(MAN3EXT) \
	  lib/CBitcoin/Transaction.pm $(INST_MAN3DIR)/CBitcoin::Transaction.$(MAN3EXT) \
	  lib/CBitcoin/TransactionInput.pm $(INST_MAN3DIR)/CBitcoin::TransactionInput.$(MAN3EXT) \
	  lib/CBitcoin/TransactionOutput.pm $(INST_MAN3DIR)/CBitcoin::TransactionOutput.$(MAN3EXT) 
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *$(LIB_EXT) *$(OBJ_EXT) \
	  *perl.core CBHD.c \
	  CBitcoin.c MYMETA.json \
	  MYMETA.yml Script.c \
	  Transaction.c TransactionInput.c \
	  TransactionOutput.c blibdirs.ts \
	  core core.*perl.*.? \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''Joel DeJesus (Work Email) <dejesus.joel@e-flamingo.jp>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: CBitcoin' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '      "Joel DeJesus (Work Email) <dejesus.joel@e-flamingo.jp>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "CBitcoin",' >> META_new.json
...
CBHD.c CBitcoin.c Script.c Transaction.c TransactionInput.c TransactionOutput.c : $(XSUBPPDEPS)
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Joel DeJesus (Work Email) &lt;dejesus.joel@e-flamingo.jp&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/CBitcoin.pm blib/lib/CBitcoin.pm \
	  lib/CBitcoin/CBHD.pm blib/lib/CBitcoin/CBHD.pm \
	  lib/CBitcoin/Script.pm blib/lib/CBitcoin/Script.pm \
	  lib/CBitcoin/Transaction.pm blib/lib/CBitcoin/Transaction.pm \
	  lib/CBitcoin/TransactionInput.pm blib/lib/CBitcoin/TransactionInput.pm \
	  lib/CBitcoin/TransactionOutput.pm blib/lib/CBitcoin/TransactionOutput.pm 
